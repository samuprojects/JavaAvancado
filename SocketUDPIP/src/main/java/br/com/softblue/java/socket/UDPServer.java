...
public class UDPServer {
	...
	public static void main(String[] args) throws Exception{
		...
		try (DatagramSocket socket = new DatagramSocket(2500)) {
			...
			System.out.println("Servidor informa: aguardando o recebimento de datagrama...");
			socket.receive(packet);
			
			byte[] clientData = packet.getData();
			String clientDataStr = new String(clientData, 0, packet.getLength());
			
			System.out.println("Servidor informa: o dado recebido do cliente foi ==> " + clientDataStr);
		}
	}
